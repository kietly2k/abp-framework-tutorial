...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6f87c33c-c4cc-4599-8888-f08ef0979080
```

> `6f87c33c-c4cc-4599-8888-f08ef0979080` is the password of the certificate, you can change it to any password you want.
